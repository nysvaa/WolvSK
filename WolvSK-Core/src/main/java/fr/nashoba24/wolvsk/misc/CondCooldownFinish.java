    	...
    	if(pl) {
    		if(player.getSingle(e)!=null) {
	    		if(WolvSK.cooldowns.containsKey(name.getSingle(e) + "." + player.getSingle(e).getName())) {
	    			return isNegated() != (WolvSK.cooldowns.get(name.getSingle(e) + "." + player.getSingle(e).getName()) < System.currentTimeMillis());
	    		}
    		}
	    	return !isNegated();
    	}
    		...
    		if(WolvSK.cooldowns.containsKey(name.getSingle(e))) {
    			return isNegated() != (WolvSK.cooldowns.get(name.getSingle(e)) < System.currentTimeMillis());
    		}
    		return !isNegated();
    	}
    }
