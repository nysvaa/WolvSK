...
public class ExprNameOfBlock extends SimpleExpression<String> implements Listener {
	...
	public void onPlace(BlockPlaceEvent e) {
		Variables.setVariable("wolvsk.nameblock." + e.getBlock().getX() + "." + e.getBlock().getY() + "." + e.getBlock().getZ() + "." + e.getBlock().getWorld().getName(), e.getItemInHand().getItemMeta().getDisplayName(), null, false);
	}
}
