...
public class ExprMathsLogBase extends SimpleExpression<Double> {
	...
	public String toString(@Nullable Event e, boolean paramBoolean) {
		return "log in base a";
	}
	
	@Override
	@Nullable
	protected Double[] get(Event e) {
        return new Double[]{ Math.log(nb.getSingle(e).doubleValue())/Math.log(base.getSingle(e).doubleValue()) };
	}
}
