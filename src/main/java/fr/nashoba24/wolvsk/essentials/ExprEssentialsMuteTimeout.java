...
public class ExprEssentialsMuteTimeout extends SimpleExpression<Long>{
	...
	protected Long[] get(Event e) {
    	...
    	return new Long[] { user.getMuteTimeout() };
	}
	...
	public void change(Event e, Object[] delta, Changer.ChangeMode mode){
		...
		if (mode == ChangeMode.SET) {
			user.setMuteTimeout((Long) delta[0]);
		}
	}
