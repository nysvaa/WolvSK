...
public class CondEssentialsCanInteractVanish extends Condition {
    ...
    public String toString(@Nullable Event e, boolean b) {
        return "player can interact vanish";
    }
    ...
    public boolean check(Event e) {
    	...
    	return isNegated() ? !user.canInteractVanished() : user.canInteractVanished();
    }
